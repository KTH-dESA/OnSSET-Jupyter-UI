...
import pandas as pd
from math import pi, ceil, exp, log, sqrt
...
class SettlementProcessor:
    ...
    def calculate_off_grid_lcoes(self, mg_hydro_calc, mg_wind_calc, mg_pv_calc,
        ...
        hydro_df = hydro_df.drop_duplicates()
        ...
        def hydro_lcoe(row):
            if row[SET_HYDRO_DIST] < max_hydro_dist:
                ...
                if int(hydro_df.loc[row[SET_HYDRO_FID], hydro_used]) > int(hydro_df.loc[row[SET_HYDRO_FID], SET_HYDRO]):
                    return 99
